    ...
    return (
        <article className={cn(COMMAND_PANEL, toneMeta.panel, 'flex h-full flex-col gap-4 p-4 sm:p-5')}>
            <div className="flex items-start justify-between gap-3">
                <div>
                    <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-500">Action</div>
                    <div className="mt-3 text-[18px] font-semibold text-slate-950">{title}</div>
                </div>
            ...
            <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-3 text-[12px] leading-relaxed text-slate-600">
                {proof}
            </div>
