...
const GOOGLE_OAUTH_ERROR_REMEDY = {
    missing_google_oauth_env: {
        headline: 'Configuration OAuth Google manquante',
        body: 'Les variables serveur `GOOGLE_OAUTH_CLIENT_ID` et `GOOGLE_OAUTH_CLIENT_SECRET` doivent être configurées avant de connecter Search Console. Aucun secret ne doit être exposé au navigateur.',
        severity: 'critical',
    },
    missing_refresh_token: {
        headline: 'Refresh token Google manquant',
        body: 'Le connecteur ne contient pas de refresh token utilisable. Relancez la connexion Google avec consentement complet pour autoriser les synchronisations en arrière-plan.',
        severity: 'critical',
    },
    no_property_access: {
        headline: 'Accès Search Console introuvable',
        body: 'Le compte Google connecté ne semble pas avoir accès à la propriété Search Console du mandat. Vérifiez la propriété GSC et les permissions, puis reconnectez si nécessaire.',
        severity: 'warning',
    },
    invalid_client: {
